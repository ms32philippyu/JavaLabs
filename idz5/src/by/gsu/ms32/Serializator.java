...
public class Serializator {
    public boolean serialization(City s, String fileName) {
        boolean flag = false;
    ...
    public City deserialization(String fileName) throws InvalidObjectException {
...
// десериализация
            City st = (City) istream.readObject();
            return st;
